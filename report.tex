...
\usepackage{amsfonts}      % AMS style math fonts (e.g. \mathbb)
...
% Macros
\NewDocumentCommand{\ALG}{}{\textsf{\upshape ALG}\xspace}
\NewDocumentCommand{\OPT}{}{\textsf{\upshape OPT}\xspace}
\NewDocumentCommand{\set}{m}{\ensuremath{\{#1\}}}
